...
- **Кросс-источниковый дедуп.** Jaccard по entities не ловил одну историю из разных изданий/языков (наблюдался Jaccard ≈ 0.25 при дублях — теракт в Ларнаке EN/GR, спасение орла и т.п.). Добавлено правило по числу общих *специфичных* сущностей (со стоп-листом вездесущих гео/издателей) → форсирует `uniqueness=3.0`. Порог дотюнен на реальных данных до **≥5 общих и ≥50% меньшего набора**: ловит явные дубли одной новости из разных изданий, но пропускает развитие сюжета (ранний `3/0.30` пересушивал ленту).
